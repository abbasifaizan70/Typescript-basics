...
just add your name and the current date at the
top of each program file.Then write one sentence describing what the program does. */
// My Name
var randonName = 'Faizan Abbasi';
// Old Date
var todayDate = new Date('18 Jul, 2023');
// priting my name with date
console.log("My name is ".concat(randonName, ". Today date is ").concat(todayDate));
