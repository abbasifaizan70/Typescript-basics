...
var places = ['Turkey', 'Germany', 'India', 'New Zeland', 'Pakistan'];
console.log('Original Array', places);
console.log('Sorted Array', __spreadArray([], places, true).sort());
console.log('Re Printed Original Array after sorting', places);
console.log('Reverse Sorted Array', __spreadArray([], places, true).sort().reverse());
